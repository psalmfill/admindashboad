...
<div class="wrapper">
  ...
  <header class="main-header" style="background-color: #25313F;">
    ...
    <a href="index2.html" class="logo" style="background-color: #25313F;">
      ...
      <span class="logo-lg" ><b>Transfer</b>Rules</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Samfield Hawb</span>
            </a>
            <ul class="dropdown-menu">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#">Transaction Analytics</a></li>
          </ul>
        </li>
            ...
            <tr>
              ...
              <td></td>
               <td>
                <button class="btn btn-success">Edit</button>
                <button class="btn btn-primary">Delete</button>
                 <button class="btn btn-danger">Ban</button></select>
              </td>
            </tr>
